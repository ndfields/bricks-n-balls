...
**Difficulty evens out at high levels.** Because you always get the same 60 balls, your damage per turn is roughly constant, so brick toughness can't rise forever or the game becomes unwinnable. It climbs normally through about level 14, then flattens into a long plateau that holds through level 200 (a row at level 200 costs about the same as one at level 30). Past level 200 it resumes rising, but at a deliberately tiny rate — roughly one point of brick strength every 20 levels — so it keeps giving late-game players something to push against without ever spiking back to unwinnable. Progression past that point comes from the full row count and denser, heavier boards, not ever-bigger numbers.
